      ...
      @method('PUT')     
       @csrf     
                <div class="form-group ">      
                    ...
                    <input type="textarea" class="form-control fg" name="title" value="{{$update->title}}">
                </div>  
        
      <div class="form-group">      
                    <label for="first_name">Content:</label><br/><br/>  
                    <textarea class="form-control cg" name="content" >{{$update->content}}</textarea>
                </div>  
      <div class="form-group ">      
                    <label for="gender">Fontawesome:</label><br/><br/>  
                    <input type="textarea" class="form-control fg" name="fontawesome" value="{{$update->fontawesome}}">  
                </div>  
      <div class="form-group ">      
                    <label for="qualifications">Color:</label><br/><br/>  
                    <input type="textarea" class="form-control fg" name="color" value="{{$update->color}}">  
                </div>  
