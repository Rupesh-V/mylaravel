 ...
 <div class="col-8 updated">
    ...
    <!-- <div class="form-group">      
     ...
     <div class="form-group">      
         ...
         <input type="textarea" class="form-control fg" name="title" value="" placeholder="donor name" required/>
     </div>  

<div class="form-group">      
         <label for="first_name">Blood Group:</label><br/><br/>  
         <input type="text" class="form-control fg" name="content" value="" placeholder="blood group" required/>  

     </div>  
<div class="form-group">      
         <label for="gender">Date Of Donation:</label><br/><br/>  
         <input type="date" class="form-control fg" name="fontawesome" value="" placeholder="date of donation" required/>  
     </div>  
<div class="form-group">      
         <label for="qualifications">Quantity (in ml):</label><br/><br/>  
         <input type="textarea" class="form-control fg" name="color" value="" placeholder="quantity in ml" required/>  
     </div>  
     <!-- <div class="form-group">      
